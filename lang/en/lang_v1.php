...
return [
    ...
    'max_rp_per_order_tooltip' => 'Maximum reward points customers can earn in one invoice. Leave it empty if you dont want any such restrictions.',
    'min_order_total_for_rp_tooltip' => '<strong>The minimum amount the customer should spend to get reward points.</strong> <br><br> <strong>Example:</strong> If you set it as 100 then customer will get reward points only if there invoice total is greater or equal to 100. If invoice total is 99 then they wont get any reward points. <br><br>You can set it as minimum 1.',
    ...
    'min_order_total_for_redeem_tooltip' => 'Minimum order total for which customers can redeem points. Leave it blank if you dont need this restriction or you need to give something for free.',
    'min_redeem_point_tooltip' => 'Minimum redeem points that can be used per invoice. Leave it blank if you dont need this restriction.',
    'max_redeem_point_tooltip' => 'Maximum points that can be used in one order. Leave it blank if you dont need this restriction.',
    ...
    'activity_log' => 'Activity Log',
    'navigated_to_products_list_from_none_added' => 'Navigated to Products List from None Added Products',
];
