...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
	...
	Route::get('products/none-added', [\App\Http\Controllers\NoneAddedProductController::class, 'index'])->name('products.none-added');
	Route::post('products/none-added/log-access', [\App\Http\Controllers\NoneAddedProductController::class, 'logProductsListAccess'])->name('products.none-added.log-access');
	Route::post('products/none-added/remove', [\App\Http\Controllers\NoneAddedProductController::class, 'removeFromNoneAdded'])->name('products.none-added.remove');
...
Route::post('/products/get_or_create_not_added_category', [App\Http\Controllers\ProductController::class, 'getOrCreateNotAddedCategory']);
