...
$(document).ready(function () {
    ...
    $(document).ready(function() {
        // Auto-hide all Bootstrap alerts after 3 seconds
        $('.alert').each(function() {
            var $alert = $(this);
            setTimeout(function() {
        ...
        // Auto-hide any new alerts that are dynamically added
        ...
        // Also handle alerts added via jQuery
        $(document).on('DOMSubtreeModified', function() {
            $('.alert:not(.auto-hide-processed)').each(function() {
                var $alert = $(this);
                $alert.addClass('auto-hide-processed');
                setTimeout(function() {
                    $alert.fadeOut('slow', function() {
                        $(this).remove();
                    });
