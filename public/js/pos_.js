         ...
         try {
            ...
            cardknoxChannel.bind('CardknoxWebhookReceived', function(data) {
                ...
                if (data.xResponseResult === 'Approved') {
                    ...
                    if (sessionId) {
                        // Call Cardknox session status endpoint
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success && response.data.xGatewayStatus === 'Approved') {
                                    toastr.success('Payment processed successfully');
                                    ...
                                    if ($('#modal_payment').is(':visible')) {
                                        ...
                                        // Ensure payment method is set to custom_pay_1 before submitting
...
$(document).ready(function() {
    ...
    $(document).on('click', '#proceed_payment_alt', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log('response',response);
                localStorage.setItem('sessionId',response.data.xSessionId);
                if (response.success) {
                    console.log("response", response);
