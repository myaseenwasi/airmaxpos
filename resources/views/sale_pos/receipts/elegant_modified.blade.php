...
<div class="row invoice-info">
	...
	<div class="col-xs-12 text-center">
		...
		<p>
			<!-- User Information -->
			@if(!empty($receipt_details->user_name))
				<strong>@lang('report.user'):</strong> {{$receipt_details->user_name}}<br>
			@endif
			@if(!empty($receipt_details->user_email))
				<strong>@lang('business.email'):</strong> {{$receipt_details->user_email}}<br>
			@endif
			@if(!empty($receipt_details->business_location))
				<strong>@lang('business.business_location'):</strong> {{$receipt_details->business_location}}<br>
			@endif
			@if(!empty($receipt_details->device_id))
				<strong>@lang('lang_v1.device_id'):</strong> {{$receipt_details->device_id}}<br>
			@endif
			@if(!empty($receipt_details->station_name))
				<strong>@lang('lang_v1.station_name'):</strong> {{$receipt_details->station_name}}<br>
			@endif
		</p>
		<p>
