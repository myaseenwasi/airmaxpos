	...
	<div class="col-xs-12 text-center">
		...
		<p style="width: 100% !important" class="word-wrap">
			...
			<span class="pull-right text-left">
				...
				<br><b>@lang('report.user'):</b> {{$receipt_details->user_name}}
				@endif
				@if(!empty($receipt_details->user_email))
				<br><b>@lang('business.email'):</b> {{$receipt_details->user_email}}
				@endif
				@if(!empty($receipt_details->business_location))
				<br><b>@lang('business.business_location'):</b> {{$receipt_details->business_location}}
				@endif
				@if(!empty($receipt_details->device_id))
				<br><b>@lang('lang_v1.device_id'):</b> {{$receipt_details->device_id}}
				@endif
				@if(!empty($receipt_details->station_name))
				<br><b>@lang('lang_v1.station_name'):</b> {{$receipt_details->station_name}}
				@endif
