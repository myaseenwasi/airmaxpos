                    ...
                    <div class="col-md-6 invoice-col width-50">
                        ...
                        @if (!empty($receipt_details->business_location))
                            <div class="text-right font-23 ">
                                ...
                                {{ $receipt_details->business_location }}
                            </div>
                        @endif
                        @if (!empty($receipt_details->device_id))
                            <div class="text-right font-23 ">
                                <span class="pull-left">
                                    @lang('lang_v1.device_id'):
                                </span>

                                {{ $receipt_details->device_id }}
                            </div>
                        @endif
                        @if (!empty($receipt_details->station_name))
                            <div class="text-right font-23 ">
                                <span class="pull-left">
                                    @lang('lang_v1.station_name'):
                                </span>

                                {{ $receipt_details->station_name }}
                            </div>
                        @endif
