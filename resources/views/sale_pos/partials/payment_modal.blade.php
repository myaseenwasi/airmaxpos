                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-primary add-payment-custom" data-value="100"><span class="display_currency" data-currency_symbol="true">1</span></button>

                                <button type="button" class="btn btn-primary  add-payment-custom" data-value="500"><span class="display_currency" data-currency_symbol="true">5</span></button>

                                <button type="button" class="btn btn-primary  add-payment-custom" data-value="1000"><span class="display_currency" data-currency_symbol="true">10</span></button>

                                <button type="button" class="btn btn-primary  add-payment-custom" data-value="2000"><span class="display_currency" data-currency_symbol="true">20</span></button>

                                <button type="button" class="btn btn-primary add-payment-custom" data-value="5000"><span class="display_currency" data-currency_symbol="true">50</span></button>

                                <button type="button" class="btn btn-primary add-payment-custom" data-value="10000"><span class="display_currency" data-currency_symbol="true">100</span></button>
