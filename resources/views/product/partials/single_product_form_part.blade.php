...
@if(!empty($only_default_selling_price))
    ...
    <table class="table table-bordered add-product-price-table table-condensed">
        ...
        <tr>
          <td>
            ...
            {!! Form::text('single_dsp', null, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => __('product.exc_of_tax'), 'id' => 'single_dsp', 'required']) !!}
            {!! Form::text('single_dsp_inc_tax', null, ['class' => 'form-control input-sm hide input_number', 'placeholder' => __('product.inc_of_tax'), 'id' => 'single_dsp_inc_tax', 'required']) !!}
          </td>
        </tr>
    </table>
</div>
